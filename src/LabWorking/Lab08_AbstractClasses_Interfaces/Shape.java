...
//Сделаем класс Shape абстрактным тк не требуется создавть экземляр данного класса
...
//Сделаем класс SolidOfRevolution абстрактным тк не требуется создавть экземляр данного класса
